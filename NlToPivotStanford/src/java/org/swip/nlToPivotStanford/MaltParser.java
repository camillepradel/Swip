...
public class MaltParser {
    ...
    public DependencyStructure posTaggedToDependecies(String[] tokens, String lang) throws MaltChainedException {
        ...
        if (lang.equals("en")) {
            service.initializeParserModel("-c engmalt.linear-1.7 -m parse -w /mnt/data/gitSwip/NlToPivotStanford/build/web/WEB-INF/classes/ -lfi parser.log");
            //            service.initializeParserModel("-c engmalt.poly-1.7 -m parse -w . -lfi parser.log");
        } else if (lang.equals("fr")) {
            service.initializeParserModel("-c fremalt-1.7 -m parse -w /mnt/data/gitSwip/NlToPivotStanford/build/web/WEB-INF/classes/ -lfi parser.log");
        } else {
            // Todo: rise exception
        }
