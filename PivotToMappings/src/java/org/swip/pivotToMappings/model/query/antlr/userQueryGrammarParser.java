// $ANTLR 3.3 Nov 30, 2010 12:45:30 /home/camille/ANTLRWorks/userQueryGrammar.g 2011-12-07 14:49:01
...
public class userQueryGrammarParser extends Parser {
    ...
    // $ANTLR start "query"
    // /home/camille/ANTLRWorks/userQueryGrammar.g:38:1: query returns [Query q] : subquerySet[$q] ( '.' subquerySet[$q] )* ( '.' )? ( 'COUNT' )? ( 'ASK' )? ;
    public final Query query() throws RecognitionException {
        Query q = null;

        try {
            // /home/camille/ANTLRWorks/userQueryGrammar.g:39:2: ( subquerySet[$q] ( '.' subquerySet[$q] )* ( '.' )? ( 'COUNT' )? ( 'ASK' )? )
            // /home/camille/ANTLRWorks/userQueryGrammar.g:39:4: subquerySet[$q] ( '.' subquerySet[$q] )* ( '.' )? ( 'COUNT' )? ( 'ASK' )?
            {
            q = new Query();
            ...
            // /home/camille/ANTLRWorks/userQueryGrammar.g:39:40: ( '.' subquerySet[$q] )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // /home/camille/ANTLRWorks/userQueryGrammar.g:39:41: '.' subquerySet[$q]
            	    {
            ...
            // /home/camille/ANTLRWorks/userQueryGrammar.g:39:63: ( '.' )?
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // /home/camille/ANTLRWorks/userQueryGrammar.g:39:64: '.'
                    {
            ...
            // /home/camille/ANTLRWorks/userQueryGrammar.g:39:70: ( 'COUNT' )?
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // /home/camille/ANTLRWorks/userQueryGrammar.g:39:71: 'COUNT'
                    {
            ...
            // /home/camille/ANTLRWorks/userQueryGrammar.g:39:102: ( 'ASK' )?
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // /home/camille/ANTLRWorks/userQueryGrammar.g:39:103: 'ASK'
                    {
    ...
    // /home/camille/ANTLRWorks/userQueryGrammar.g:42:1: subquerySet[Query q] : ( e1q23[$q] ':' q23End[$q, $e1q23.qe] ( ';' q23End[$q, $e1q23.qe] )* | e1q1[$q] );
    public final void subquerySet(Query q) throws RecognitionException {
        ...
        try {
            // /home/camille/ANTLRWorks/userQueryGrammar.g:43:2: ( e1q23[$q] ':' q23End[$q, $e1q23.qe] ( ';' q23End[$q, $e1q23.qe] )* | e1q1[$q] )
            int alt6=2;
            switch ( input.LA(1) ) {
            case 17:
                {
            ...
            switch (alt6) {
                case 1 :
                    // /home/camille/ANTLRWorks/userQueryGrammar.g:43:4: e1q23[$q] ':' q23End[$q, $e1q23.qe] ( ';' q23End[$q, $e1q23.qe] )*
                    {
                    ...
                    // /home/camille/ANTLRWorks/userQueryGrammar.g:43:40: ( ';' q23End[$q, $e1q23.qe] )*
                    loop5:
                    do {
                        int alt5=2;
                        ...
                        switch (alt5) {
                    	case 1 :
                    	    // /home/camille/ANTLRWorks/userQueryGrammar.g:43:41: ';' q23End[$q, $e1q23.qe]
                    	    {
                    ...
                    break;
                case 2 :
                    // /home/camille/ANTLRWorks/userQueryGrammar.g:44:4: e1q1[$q]
                    {
    ...
    // $ANTLR start "e1q1"
    // /home/camille/ANTLRWorks/userQueryGrammar.g:47:1: e1q1[Query q] returns [QueryElement qe] : keyword[$q] ;
    public final QueryElement e1q1(Query q) throws RecognitionException {
        ...
        try {
            // /home/camille/ANTLRWorks/userQueryGrammar.g:48:2: ( keyword[$q] )
            // /home/camille/ANTLRWorks/userQueryGrammar.g:48:4: keyword[$q]
            {
    ...
    // $ANTLR start "e1q23"
    // /home/camille/ANTLRWorks/userQueryGrammar.g:51:1: e1q23[Query q] returns [QueryElement qe] : keyword[$q] ;
    public final QueryElement e1q23(Query q) throws RecognitionException {
        ...
        try {
            // /home/camille/ANTLRWorks/userQueryGrammar.g:52:2: ( keyword[$q] )
            // /home/camille/ANTLRWorks/userQueryGrammar.g:52:4: keyword[$q]
            {
    ...
    // $ANTLR start "q23End"
    // /home/camille/ANTLRWorks/userQueryGrammar.g:56:1: q23End[Query q, QueryElement e1] : ( e2q3[$q] '=' q3End[$q, $e1, $e2q3.qe] ( ',' q3End[$q, $e1, $e2q3.qe] )* | e2q2[$q] );
    public final void q23End(Query q, QueryElement e1) throws RecognitionException {
        ...
        try {
            // /home/camille/ANTLRWorks/userQueryGrammar.g:57:2: ( e2q3[$q] '=' q3End[$q, $e1, $e2q3.qe] ( ',' q3End[$q, $e1, $e2q3.qe] )* | e2q2[$q] )
            int alt8=2;
            switch ( input.LA(1) ) {
            case 17:
                {
            ...
            switch (alt8) {
                case 1 :
                    // /home/camille/ANTLRWorks/userQueryGrammar.g:57:4: e2q3[$q] '=' q3End[$q, $e1, $e2q3.qe] ( ',' q3End[$q, $e1, $e2q3.qe] )*
                    {
                    ...
                    // /home/camille/ANTLRWorks/userQueryGrammar.g:57:42: ( ',' q3End[$q, $e1, $e2q3.qe] )*
                    loop7:
                    do {
                        int alt7=2;
                        ...
                        switch (alt7) {
                    	case 1 :
                    	    // /home/camille/ANTLRWorks/userQueryGrammar.g:57:43: ',' q3End[$q, $e1, $e2q3.qe]
                    	    {
                    ...
                    break;
                case 2 :
                    // /home/camille/ANTLRWorks/userQueryGrammar.g:58:4: e2q2[$q]
                    {
    ...
    // $ANTLR start "e2q2"
    // /home/camille/ANTLRWorks/userQueryGrammar.g:61:1: e2q2[Query q] returns [QueryElement qe] : ( keyword[$q] | literal[$q] );
    public final QueryElement e2q2(Query q) throws RecognitionException {
        ...
        try {
            // /home/camille/ANTLRWorks/userQueryGrammar.g:62:2: ( keyword[$q] | literal[$q] )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // /home/camille/ANTLRWorks/userQueryGrammar.g:62:4: keyword[$q]
                    {
                    ...
                    break;
                case 2 :
                    // /home/camille/ANTLRWorks/userQueryGrammar.g:63:4: literal[$q]
                    {
    ...
    // $ANTLR start "e2q3"
    // /home/camille/ANTLRWorks/userQueryGrammar.g:67:1: e2q3[Query q] returns [QueryElement qe] : keyword[$q] ;
    public final QueryElement e2q3(Query q) throws RecognitionException {
        ...
        try {
            // /home/camille/ANTLRWorks/userQueryGrammar.g:68:2: ( keyword[$q] )
            // /home/camille/ANTLRWorks/userQueryGrammar.g:68:4: keyword[$q]
            {
    ...
    // $ANTLR start "q3End"
    // /home/camille/ANTLRWorks/userQueryGrammar.g:72:1: q3End[Query q, QueryElement e1, QueryElement e2] : e3q3[$q] ;
    public final void q3End(Query q, QueryElement e1, QueryElement e2) throws RecognitionException {
        QueryElement e3q310 = null;


        try {
            // /home/camille/ANTLRWorks/userQueryGrammar.g:73:2: ( e3q3[$q] )
            // /home/camille/ANTLRWorks/userQueryGrammar.g:73:4: e3q3[$q]
            {
    ...
    // $ANTLR start "e3q3"
    // /home/camille/ANTLRWorks/userQueryGrammar.g:76:1: e3q3[Query q] returns [QueryElement qe] : ( keyword[$q] | literal[$q] );
    public final QueryElement e3q3(Query q) throws RecognitionException {
        ...
        try {
            // /home/camille/ANTLRWorks/userQueryGrammar.g:77:2: ( keyword[$q] | literal[$q] )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // /home/camille/ANTLRWorks/userQueryGrammar.g:77:4: keyword[$q]
                    {
                    ...
                    break;
                case 2 :
                    // /home/camille/ANTLRWorks/userQueryGrammar.g:78:4: literal[$q]
                    {
    ...
    // $ANTLR start "keyword"
    // /home/camille/ANTLRWorks/userQueryGrammar.g:82:1: keyword[Query q] returns [Keyword k] : ( '?' )? ( '$' INT )? ID ;
    public final Keyword keyword(Query q) throws RecognitionException {
        ...
        try {
            // /home/camille/ANTLRWorks/userQueryGrammar.g:83:2: ( ( '?' )? ( '$' INT )? ID )
            // /home/camille/ANTLRWorks/userQueryGrammar.g:83:4: ( '?' )? ( '$' INT )? ID
            {
            ...
            // /home/camille/ANTLRWorks/userQueryGrammar.g:88:3: ( '?' )?
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // /home/camille/ANTLRWorks/userQueryGrammar.g:88:4: '?'
                    {
            ...
            // /home/camille/ANTLRWorks/userQueryGrammar.g:89:3: ( '$' INT )?
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // /home/camille/ANTLRWorks/userQueryGrammar.g:89:4: '$' INT
                    {
    ...
    // $ANTLR start "literal"
    // /home/camille/ANTLRWorks/userQueryGrammar.g:126:1: literal[Query q] returns [Literal l] : ID LITVALUE ;
    public final Literal literal(Query q) throws RecognitionException {
        ...
        try {
            // /home/camille/ANTLRWorks/userQueryGrammar.g:127:2: ( ID LITVALUE )
            // /home/camille/ANTLRWorks/userQueryGrammar.g:127:4: ID LITVALUE
            {
