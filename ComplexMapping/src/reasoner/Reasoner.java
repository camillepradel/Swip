 ...
 * 
 *         A class which contains some methods used in the classes
 *         ReasonerOneOntology and ReasonerTwoOntologies. One method create a
 *         reasoner: load the ontology, build a pellet reasoner and load the
 *         ontology into the reasoner. Another method computes all things like
 *         sub-or superclasses of a given classs.
 * 
 */
public class Reasoner {
	...
	public OWLReasoner createReasoner(URI ont) throws ComplexMappingException {
		...
		try {
			...
			// manager.loadOntologyFromPhysicalURI(ont);
			IRI iri;
			...
			throw new ComplexMappingException(
					ComplexMappingException.BAD_METHOD_CALL,
					"Unsupported opertation ", exception);
//		} catch (OWLReasonerException ex) {
//			throw new ComplexMappingException(
//					ComplexMappingException.REASONER_EXCEPTION,
//					"An error occured while reasoning the ontologies.", ex);
		} catch (OWLOntologyCreationException e) {
			throw new ComplexMappingException(
					ComplexMappingException.CREATION_EXCEPTION,
	...
	public static NodeSet<OWLClass> getClasses(int type, OWLReasoner reasoner,
		...
		default:
			throw new ComplexMappingException(
					ComplexMappingException.BAD_PARAMETER, "Wrong type: "
							+ type);
		}
