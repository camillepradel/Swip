...
public class Correspondence implements Comparable<Correspondence>  {
	...
	* Checking wether the uri reference can be resolved does not occur in this context.
	*/
	public Correspondence(URI sourceEntityUri, URI targetEntityUri, SemanticRelation relation, double confidence) throws CorrespondenceException {
		this.sourceEntityUri = sourceEntityUri.toString();
		this.targetEntityUri = targetEntityUri.toString();
		this.setRelation(relation);
	...
	*/
	...
	public void setSourceEntityUri(String sourceEntity) throws CorrespondenceException {
		...
		// System.out.println(this.sourceEntityUri);
