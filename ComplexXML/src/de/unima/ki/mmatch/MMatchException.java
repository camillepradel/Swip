 ...
 *
 * Every exception, which occurs while matching, is converted into a MMatchException.
 * If a MMatchException is thrown, additional information about the Exception are
 * printed, for example where the exception occurs and why.
 *
 */
